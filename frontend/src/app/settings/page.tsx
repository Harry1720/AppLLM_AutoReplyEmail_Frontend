...
export default function SettingsPage() {
  ...
  const handleDeleteAccount = async () => {
    const confirmed = await confirm({
      ...
      message:
        "Bạn có chắc chắn muốn ngắt kết nối tài khoản? Hành động này không thể hoàn tác!",
                      ...
                      <div className="flex">
                        ...
                        <div className="ml-3">
                          <p className="mt-1 text-sm text-blue-700">
                            Dữ liệu sẽ được cập nhật khi bạn quay về trang làm
                            việc.
                          </p>
                        </div>
                      </div>
